...
const RegisterModal: React.FC<RegisterModalProps> = ({ onClose, onLogin }) => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md glass-card rounded-2xl shadow-2xl p-8 animate-in zoom-in-95 duration-200">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 text-sm mt-2">Start your skill exchange journey today.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full py-3 mt-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold shadow-lg shadow-primary-600/30 transition-all active:scale-95"
          >
            Create Account
          </button>
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-white dark:bg-slate-900 px-2 text-slate-500">Or use</span></div>
          </div>
